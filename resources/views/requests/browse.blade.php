                ...
                <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="max-w-2xl">
                        ...
                        <h1 class="text-2xl font-bold tracking-tight sm:text-3xl">
                            Find students who need your skills.
                        </h1>

                        <p class="mt-3 max-w-xl text-sm leading-6 text-indigo-100 sm:text-base">
                            Explore open learning requests from students and discover
            ...
            <div class="mb-5 flex items-end justify-between gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Browse students who are looking for help with skills you can teach.
                    </p>
                </div>
