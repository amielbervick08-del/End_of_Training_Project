        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('requests.browse')" :active="request()->routeIs('requests.browse')">
                        {{ __('Browse Requests') }}
                    </x-nav-link>

                    <x-nav-link :href="route('skill-exchanges.index')" :active="request()->routeIs('skill-exchanges.*')">
                        {{ __('Skill Exchange') }}
                    </x-nav-link>
